...
describe("<AddContent />", () => {
  ...
  test("testing getting all content", async () => {
    getAllContent.mockImplementation(() => [
      {
        title: "test header",
        content: "test body",
    ...
    await waitFor(() =>
      expect(screen.getByTestId("header-body")).toHaveTextContent(
        "Content: test body"
      )
    );
    await waitFor(() =>
  ...
  test("testing undefined response", async () => {
    ...
    await waitFor(() =>
      expect(screen.getByTestId("header-body")).toHaveTextContent("Content: -")
    );
    await waitFor(() =>
      expect(screen.getByTestId("header-date")).toHaveTextContent(
        "Date Created: -"
