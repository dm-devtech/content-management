...
CREATE TABLE posts(content_id SERIAL PRIMARY KEY, title VARCHAR(255) NOT NULL, content VARCHAR(255) NOT NULL, date_created TIMESTAMP);
-- 4. !!IMPORTANT!! Create pgcrypto extension to encrypt passwords in users table
CREATE EXTENSION pgcrypto;
-- 5. Create Users table
CREATE TABLE users(user_id SERIAL PRIMARY KEY, email VARCHAR(255) NOT NULL,
  password VARCHAR(350) NOT NULL, role VARCHAR(50) NOT NULL, date_created TIMESTAMP);
